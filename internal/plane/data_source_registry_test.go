...
func TestResolverWithRegistryPrefersAnnouncedSourceAndFallsBack(t *testing.T) {
	...
	resolve := ResolverWithRegistry(reg, fallback)
...
func TestResolverWithRegistryPropagatesFallbackErrors(t *testing.T) {
	...
	resolve := ResolverWithRegistry(NewDataSourceRegistry(), func(context.Context, string, int64) (string, bool, error) {
...
// announcement can have arrived.
func TestResolverWithRegistryToleratesNilRegistry(t *testing.T) {
	resolve := ResolverWithRegistry(nil, func(context.Context, string, int64) (string, bool, error) {
		return "leader:7000", true, nil
	})
