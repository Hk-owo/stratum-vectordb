...
func (r *gcTestRaftNode) ProposeRetryVersion(_ context.Context, _ string, _ int64, _ types.FailureSide) error {
	return nil
}
...
func (r *gcTestRaftNode) ProposeDiscardVersion(_ context.Context, _ string, _ int64) error {
	return nil
}
