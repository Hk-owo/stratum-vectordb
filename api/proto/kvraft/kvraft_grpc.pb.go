...
const (
	Raft_RequestVote_FullMethodName     = "/kvraft.Raft/RequestVote"
	Raft_AppendEntries_FullMethodName   = "/kvraft.Raft/AppendEntries"
	Raft_InstallSnapshot_FullMethodName = "/kvraft.Raft/InstallSnapshot"
)
